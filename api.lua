...
local json = (loadfile "/home/inline/inline/JSON.lua")()
local token = '350508129:AAEncZesB4WUmEJxJutXEBqJ93XZJeNRyqA' --token
local url = 'https://api.telegram.org/bot' .. token
local offset = 0
local redis = require('redis')
local redis = redis.connect('127.0.0.1', 6379)
local SUDO = 274807882
        ...
        for i=1, #updates.result do
          ...
          if msg.inline_query then
            local q = msg.inline_query
						if q.from.id == 322190322 or q.from.id == 350508129 then
